...
export const PrivacyPolicyContent: React.FC = () => {
  return (
    <>
      <h1 className="text-2xl sm:text-3xl font-bold text-[#1c243c] mb-4 text-center">
        PRIVACY POLICY
      </h1>
      ...
      <h2 className="text-xl md:text-2xl font-semibold text-[#1c243c] mt-8 mb-4">
        1. Introduction
      </h2>
      ...
      <h3 className="text-lg md:text-xl font-semibold text-[#1c243c] mt-5 mb-2">
        Personal Identifiers:
      </h3>
      <ul className="list-disc list-inside mb-5 space-y-1 text-gray-700 pl-4 text-sm md:text-base">
        <li>Full name</li>
        <li>Email address</li>
      ...
      <ul className="list-disc list-inside mb-6 space-y-1 text-gray-700 pl-4 text-sm md:text-base">
      ...
      <div className="text-gray-700 leading-relaxed space-y-0.5 text-sm md:text-base">
